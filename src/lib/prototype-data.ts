...
export const navItems: NavItem[] = [
  {
    ...
    label: "Overview",
    shortLabel: "Overview",
    description: "Ringkasan dua web JBD",
    icon: Sparkles,
  },
  {
    href: "/storefront",
    label: "Frontstore Web",
    shortLabel: "Frontstore",
    description: "Marketplace customer dari discovery sampai loyalty",
    icon: Store,
  },
  {
    href: "/admin",
    label: "Admin Console",
    shortLabel: "Admin",
    description: "Admin, operations, dan insights",
  ...
  },
  {
    ...
    shortLabel: "Finance",
    description: "AR, AP, GL, HPP, profit, dan cashflow",
...
export const appSidebarMenus: Record<string, SidebarMenuItem[]> = {
  storefront: [
    ...
    {
      href: "/storefront/search",
      label: "Search Product",
      description: "Cari SKU & filter",
      icon: Search,
    },
    {
      href: "/storefront/live",
      label: "Live & Shorts",
      description: "Video promo produk",
      icon: Video,
    },
    {
      href: "/storefront/recipes",
      label: "Resep",
      description: "Recipe, menu, tutorial",
      icon: BookOpen,
    },
    {
    ...
    {
      href: "/storefront/notifications",
      label: "Notifications",
      description: "Order, promo, chat",
      icon: Bell,
    },
    {
      href: "/storefront/chat",
      label: "Chat",
      description: "Bantuan & sales",
      icon: MessageSquareMore,
    },
    {
      href: "/storefront/profile",
      label: "Profile",
      description: "Pesanan, alamat, voucher",
      icon: User,
    },
    {
      href: "/storefront/profile/orders",
      label: "My Orders",
      description: "Belum bayar, dikemas, dikirim",
      icon: Package,
    },
    {
    ...
    {
      href: "/storefront/profile/addresses",
      label: "Shipping Address",
      description: "Alamat pelanggan",
      icon: MapPin,
    },
    {
      href: "/storefront/profile/settings",
      label: "Settings",
